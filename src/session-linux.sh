...
# Version 0.7.2, released 03-01-2011.
#
...
tools_native="awk cut gnome-terminal grep nslookup pgrep sed ssh scp smbclient uuidgen"
...
discoveryHelper(){
    ...
    if [ "$norange" ]; then
        ...
        nmap -n -T5 -PE -oG /tmp/session.discover.out -sP $range > /dev/null
